    ...
    <ScrollAnimation>
      <div id='home' className=' flex flex-col w-full justify-center items-center mx-auto my-20'>
        <div className='lg:w-full px-10  xl:w-4/5 2xl:w-3/5 pb-20 flex flex-col justify-center items-center gap-10 text-center mb-10'>
          ...
          <p className='font-bold text-xl lg:text-2xl xl:text-4xl 2xl:text-5xl'>Website Design & SEO For <br /> <b className='underline font-italic'>Creative Professionals.</b></p>
          <p className='lg:text-xl text-gray-500'>Beautiful, SEO-friendly websites for <b>photographers, artists,</b> and <b>galleries.</b>Showcase your talent and let your work bring in more clients!</p>
        ...
        <div className='pt-10 w-full flex justify-center items-center gap-4'>
          <div className='w-1/3 hidden sm:block'><hr /></div>
