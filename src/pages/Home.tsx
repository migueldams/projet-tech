    ...
    <ScrollAnimation>
      <div id='home' className=' flex flex-col w-full justify-center items-center mx-auto my-20'>
        <div className='lg:w-full px-10  xl:w-4/5 2xl:w-3/5 pb-20 flex flex-col justify-center items-center gap-10 text-center mb-10'>
          ...
          <p className='font-bold text-xl lg:text-2xl xl:text-4xl 2xl:text-5xl'>Solutions Technologiques Innovantes pour <br /> <b className='underline font-italic'>Entreprises et Particuliers</b></p>
