        ...
        <ScrollAnimation>
            <div id='service' className='w-full flex flex-col justify-center items-center'>
                <div className='flex flex-col justify-center items-center my-20 gap-10'>
                    <Title h1="Nos Services Technologiques et Solutions Informatiques." h2="TECH SOLUTION S.A propose une large gamme de services IT et solutions digitales professionnelles adaptés aux entreprises et particuliers." />
                            ...
                            <div className='w-full md:w-1/2 h-1/2 md:h-full flex flex-col justify-center md:gap-7 md:pl-10'>
                                ...
                                <ul>
                                    {item.content.map((content: string, index: number) => (
                                        <p key={index} className='text-gray-800 font-semibold text-sm lg:text-md xl:text-xl list-disc list-inside'><Check className="w-4 h-4 mr-2 inline text-green-600" />{content}</p>
                                    ))}
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className='flex flex-col justify-center items-center my-20 gap-10'>
                        ...
                        <div className='flex flex-col md:flex-row gap-10 w-4/5 justify-between'>
                            {partern.slice(0, 3).map((item) => (
                                <div key={item.id} className='flex flex-col justify-center bg-gray-100 gap-10 w-full md:w-1/3 rounded-sm p-5'>
                        ...
                        <div className='my-10 border-2 rounded-2xl w-4/5 flex  items-center p-10 gap-10 flex-col md:flex-row '>
                            ...
                            <div className='flex flex-col gap-4 '>
                                <p className='font-semibold text-2xl mb-2'>Ecrivez nous et trouvons la solution a votre probleme ?</p>
                                <p className='text-gray-500  '>contactez votre equipe d'experts et nous vous aiderons a avoir cette solution qui vous manque .</p>
                            </div>
                            <div>
                                <button className='text-center rounded-full bg-black w-50 text-white  gap-2 px-4 py-4 flex justify-center items-center'>Contactez nous <ArrowRight /></button>
                            </div>
                        </div>
                    </div>
                </ScrollAnimation>
                ...
                <ScrollAnimation>
                    <div className='flex flex-col justify-center items-center gap-10 w-full lg:w-4/5 py-20'>
                        <Title h1="choisissez parmie notre catetalogue votre solution" h2="identifier votre probleme et votre offrirons la solution atravres notre équipe d'experts" />
                        <div className='flex flex-col md:flex-row gap-5'>
                            <Stick icon={<svg xmlns="http://www.w3.org/2000/svg" width="20" height="17" fill="#202020"><path d="M9.25 8.25v2.25q0 .32.216.534a.73.73 0 0 0 .534.216.73.73 0 0 0 .534-.216.73.73 0 0 0 .216-.534V8.25H13a.73.73 0 0 0 .534-.216.73.73 0 0 0 .216-.534.73.73 0 0 0-.216-.535A.73.73 0 0 0 13 6.75h-2.25V4.5a.73.73 0 0 0-.216-.534A.73.73 0 0 0 10 3.75a.73.73 0 0 0-.534.216.73.73 0 0 0-.216.534v2.25H7a.73.73 0 0 0-.535.215.73.73 0 0 0-.215.535q0 .32.215.534A.73.73 0 0 0 7 8.25zM2.308 15q-.758 0-1.283-.525A1.75 1.75 0 0 1 .5 13.192V1.808q0-.758.525-1.283T2.308 0h15.384q.758 0 1.283.525t.525 1.283v11.384q0 .758-.525 1.283T17.692 15H13.5v1.096a.88.88 0 0 1-.259.645.88.88 0 0 1-.645.259H7.404a.88.88 0 0 1-.645-.259.88.88 0 0 1-.259-.645V15zm0-1.5h15.384a.3.3 0 0 0 .212-.096.3.3 0 0 0 .096-.212V1.808a.3.3 0 0 0-.096-.212.3.3 0 0 0-.212-.096H2.308a.3.3 0 0 0-.212.096.3.3 0 0 0-.096.212v11.384q0 .116.096.212a.3.3 0 0 0 .212.096"></path></svg>} content="We Create For The Pros" />
