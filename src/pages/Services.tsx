            ...
            <div id='service' className='w-full flex flex-col justify-center items-center'>
                <div className='flex flex-col justify-center items-center my-20 gap-10'>
                    ...
                    <div className='flex flex-col md:flex-row px-10 xl:px-0 w-full xl:w-4/5 2xl:w-3/5 gap-5 justify-between md:items-center'>
                        ...
                        <div>
                            ...
                            <p className='text-sm sm:text-md lg:text-xl'>Clients Use and Love Our Products</p>
                        </div>
                        <div>
                            <Counter target={4} text={"weeks"} />
                            <p className='text-sm sm:text-md lg:text-xl'>Fast Delivery time</p>
                        </div>
                    </div>
                </div>
                ...
                <ScrollAnimation>
                    <div className='flex flex-col justify-center items-center gap-10 w-full lg:w-4/5 py-20'>
                        <Title h1="Choose a Website Design That Complements Your Vision." h2="Choose your starter template, and we’ll customize it to perfectly align with your brand and vision" />
                        ...
                        <div className='grid grid-cols-1 md:grid-cols-2  gap-10 w-full px-10 md:px-20'>
                            {galleries.map((item) => (
                                <div key={item.id} className='flex flex-col w-full justify-center  gap-5'>
                                    ...
                                    <p className='text-gray-500 '>{item.description}</p>
                                    <div className='flex w-full gap-8'><button className='text-center rounded-full bg-black w-50 text-white  gap-2 px-4 py-4 flex justify-center items-center shadow-xl shadow-black'>Get Started</button>
                                    </div>
                                </div>
                            ))}
                        </div>
